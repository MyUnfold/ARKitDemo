...
extension VirtualObject {
    ...
    static func getObjects(forData: [VirtualObjectData]) -> [VirtualObject] {
        let object = VirtualObject.availableObjects
    ...
    static let availableObjects: VirtualObject = {
        let modelsURL = Bundle.main.url(forResource: "Models.scnassets/painting1/painting.scn", withExtension: nil)!
        let object = VirtualObject(url: modelsURL)
        return object!
    }()
